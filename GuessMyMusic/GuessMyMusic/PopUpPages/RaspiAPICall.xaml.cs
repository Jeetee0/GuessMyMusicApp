    ...
    public partial class RaspiAPICall : ContentPage
    {
        ...
        async public void handleSendRequest(object sender, EventArgs e) {
            if (ipEntry.Text.Equals("") || portEntry.Text.Equals("") || pathEntry.Text.Equals(""))
                ...
                //if delay is set more then 400 the demo takes to long. so we wont wait for the response
                if (TappingPage.avg >= 400 && pathEntry.Text.Equals("/controlOskarsRaspberryPi/disco/wait"))
        ...
        public void handlePredefine(object sender, EventArgs e) {
            ...
            portEntry.Text = "8080";
            pathEntry.Text = "/controlOskarsRaspberryPi/disco/wait";
