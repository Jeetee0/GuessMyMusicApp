...
namespace GuessMyMusic.Models
{
    public class RhythmApi
    {
        ...
        //also found out, that this api has no electronic genres in their database
        //switching focus to http request to raspberry

        //edit: wrote my own database with a few example interpretes for each genre
